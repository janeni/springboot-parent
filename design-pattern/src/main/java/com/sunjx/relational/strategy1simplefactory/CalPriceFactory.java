...
public class CalPriceFactory {
    ...
    private static final String CAL_PRICE_PACKAGE = "com.sunjx.relational.strategy1simplefactory";//这里是一个常量，表示我们扫描策略的包
    ...
    private static PriceRegion handleAnnotation(Class<? extends CalPrice> clazz) {
